...
def main():
    ...
    for f in data_files:
        ...
        for turn in data_json['turns']:
            ...
            # Check if the iteration of ans and pred actually matches
            # print('ans  turn-index:', turn['turn-index'], 'pred turn-index:', eval_json['turns'][eval_index]['turn-index'])
            # print('ans   utterance:', turn['utterance'])
